...
public class HeaderLocationQuestion extends HeaderQuestion {
  ...
  private static final String DEFAULT_FAILURE_ENVIRONMENT = "";
  ...
  private static final String FAILURE_ENVIRONMENT_VAR = "failureEnvironment";
  ...
  private String _failureEnvironment;
  ...
  public HeaderLocationQuestion() {
    ...
    _failureEnvironment = DEFAULT_FAILURE_ENVIRONMENT;
  ...
  public HeaderLocationQuestion(HeaderLocationQuestion other) {
    ...
    this._failureEnvironment = other._failureEnvironment;
  ...
  @JsonProperty(FAILURE_ENVIRONMENT_VAR)
  public String getFailureEnvironment() {
    return _failureEnvironment;
  }
  ...
  @JsonProperty(FAILURE_ENVIRONMENT_VAR)
  public void setFailureEnvironment(String failureEnvironment) {
    _failureEnvironment = failureEnvironment;
  }
